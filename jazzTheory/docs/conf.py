...
sys.path.insert(0, os.path.abspath('..'))
sys.path.insert(0, os.path.abspath('../jazzTheory'))
from base import *
...
html_theme_options = {
    ...
    'globaltoc_depth': -1,  # Global TOC depth for "site" navbar tab. (Default: 1) Switching to -1 shows all levels.
    'globaltoc_includehidden': "true",  # Include hidden TOCs in Site navbar?

    # HTML navbar class (Default: "navbar") to attach to <div> element.
    # For black navbar, do "navbar navbar-inverse"
    'navbar_class': "navbar",
    'navbar_fixed_top': "true",  # Fix navigation bar to top of page?
...
htmlhelp_basename = 'jazzTheorydoc'
...
latex_documents = [
    (master_doc, 'jazzTheory.tex', 'jazzTheory Documentation',
     'Remy Wahnoun', 'manual'),
]
...
man_pages = [
    (master_doc, 'jazztheory', 'jazzTheory Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'jazzTheory', 'jazzTheory Documentation',
     author, 'jazzTheory', 'One line description of project.',
     'Miscellaneous'),
]
